...
function Home() {
  return (
    <div className="min-h-screen bg-slate-900 text-white p-4 md:p-6">
      {/* Top section - Analyser with fixed height */}
      ...
      <div className="flex flex-col lg:flex-row gap-[2%] justify-between">
        ...
        <div className="w-full lg:w-[49%] flex justify-center items-start">
          <div className="bg-slate-800 border-slate-700 p-3 md:p-4 rounded-lg shadow-lg w-full lg:w-[96%] flex flex-col items-center">
            <ChessBoard />
            {/* Navigation arrows */}
